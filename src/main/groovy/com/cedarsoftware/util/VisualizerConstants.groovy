...
class VisualizerConstants
{
	...
	public static final String OPTIONAL_SCOPE_AVAILABLE_TO_LOAD = 'Since not all optional scope keys were provided, one or more default values were used to load '
	public static final String ADD_SCOPE_VALUES_FOR_OPTIONAL_KEYS = 'Scope value(s) may be supplied for the following optional scope key(s): '
	public static final String ADDITIONAL_SCOPE_REQUIRED_TO_LOAD = 'Additional scope is required to load '
	public static final String ADD_SCOPE_VALUES_FOR_REQUIRED_KEYS = 'Scope value(s) must be supplied for the following required scope key(s): '
